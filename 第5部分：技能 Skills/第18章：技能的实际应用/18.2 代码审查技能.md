...
ä»£ç �å®¡æŸ¥æŠ€èƒ½æ˜¯ Claude Code Skills ä¸­ç”¨äº�è‡ªåŠ¨åŒ–ä»£ç �å®¡æŸ¥çš„é‡�è¦�å·¥å…·ã€‚å®ƒå�¯ä»¥å¸®åŠ©å¼€å�‘è€…å¿«é€Ÿè¯†åˆ«ä»£ç �ä¸­çš„é—®é¢˜ï¼Œæ��é«˜ä»£ç �è´¨é‡�å’Œå�¯ç»´æŠ¤æ€§ã€‚
...
class CodeReviewerSkill(Skill):
    ...
    def check_naming_conventions(self, code: str, language: str) -> List[Dict]:
        ...
        if language == "python":
            # æ£€æŸ¥å‡½æ•°å��ï¼ˆåº”è¯¥æ˜¯ snake_caseï¼‰
...
#### 1. è‡ªåŠ¨å®¡æŸ¥
- åœ¨æ��äº¤å‰�è‡ªåŠ¨è¿�è¡Œ
- é›†æˆ�åˆ° CI/CD æµ�ç¨‹
- é˜»æ­¢ä¸�ç¬¦å�ˆè§„èŒƒçš„ä»£ç �

### 2. äººå·¥å®¡æŸ¥
- å®¡æŸ¥è‡ªåŠ¨å®¡æŸ¥ç»“æ�œ
- å…³æ³¨å¤�æ�‚é€»è¾‘
- æ��ä¾›å»ºè®¾æ€§å��é¦ˆ
...
ä»£ç �å®¡æŸ¥æŠ€èƒ½å�¯ä»¥å¸®åŠ©å›¢é˜Ÿè‡ªåŠ¨åŒ–ä»£ç �å®¡æŸ¥æµ�ç¨‹ï¼Œæ��é«˜ä»£ç �è´¨é‡�å’Œä¸€è‡´æ€§ã€‚é€šè¿‡å�ˆç�†é…�ç½®å®¡æŸ¥è§„åˆ™å’Œæµ�ç¨‹ï¼Œå�¯ä»¥æ˜¾è‘—å‡�å°‘ä»£ç �ä¸­çš„é—®é¢˜ï¼Œæ��é«˜å¼€å�‘æ•ˆç�‡ã€‚

åœ¨ä¸‹ä¸€èŠ‚ä¸­ï¼Œæˆ‘ä»¬å°†æ�¢è®¨æ–‡æ¡£ç”Ÿæˆ�æŠ€èƒ½ã€‚
